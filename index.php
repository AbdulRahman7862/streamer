...
?>
  ...
  .logout-btn {
    ...
    cursor: pointer;
    font-size: 1rem;
    margin-top: 20px; /* adds vertical space from the heading */
...
<div class="container">
    ...
    <p class="head">
      <span style="font-family: Arial, sans-serif">
        <strong><u>
          ...
          <a href="https://brave.com/" class="gold-text" style="text-decoration: underline;" target="_blank">
            <img src="images/S2UB31723335663.png" alt="BRAVE Browser" style="height: 24px; vertical-align: middle;">
          </a>
          OR use this AdBlocker
          <a href="https://ublockorigin.com/" class="gold-text" style="text-decoration: underline;" target="_blank">
    ...
    <div class="section filter-item" data-category="movies">
        ...
        <div class="icon-link">
            <a href="https://www.vidbinge.com/" target="_blank">
